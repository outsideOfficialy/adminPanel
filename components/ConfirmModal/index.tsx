            ...
            <div className="w-full max-h-[65dvh] md:max-h-[50dvh] overflow-auto flex flex-col gap-[45px] pr-[15px]">
              ...
              <div className="flex flex-col gap-[10px]">
                ...
                <div className="pl-[10px] flex gap-[15px]">
                  <span>
                    <Image className="platform-img" src={spotify} alt="spotify" />
                  </span>
                  <span>
                    <Image className="platform-img" src={soundcloud} alt="soundcloud" />
                  </span>
                  <span>
                    <Image className="platform-img" src={itunes} alt="itunes" />
                  </span>
                  <span>
                    <Image className="platform-img" src={youtubeMusic} alt="youtubeMusic" />
                  </span>
                </div>
              </div>
              <div className="flex flex-col gap-[10px]">

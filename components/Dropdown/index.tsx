              ...
              <div key={el.platformName + idx}>
                ...
                <div className="flex justify-between items-center px-[5px]">
                  ...
                  <input
                    ...
                    className={clsx(
                      "bg-black border rounded-lg border-white text-white py-[10px] px-[10px] max-w-[350px] w-full text-[14px] font-normal font-medium leading-normal tracking-wider transition duration-300 ease-in-out placeholder-grey focus:border-main-primary-color focus:ring-0 focus:outline-none "
                    )}
                  />
                </div>
              </div>
